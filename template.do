...
/*e*/
/* one of the greatest concerns for this model remains in variables that vary significantly across states but vary little within a state over time. As mentioned above, this may be perceptions of guns and gun usage across states, etc...*/
